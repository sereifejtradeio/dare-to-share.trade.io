    ...
    $.fn.fullpage = function(options) {
        ...
        FP.setAutoScrolling = function(value, type) {
            ...
            if (options.autoScrolling && !options.scrollBar) {
                ...
                FP.setRecordHistory(!1, 'internal');
                container.css({
                    '-ms-touch-action': '',
                    'touch-action': ''
                });
        ...
        FP.setResponsive = function(active) {
            ...
            if (active) {
                if (!isResponsive) {
                    FP.setAutoScrolling(!1, 'internal');
                    FP.setFitToSection(!1, 'internal');
        ...
        var originals = $.extend(!0, {}, options);
        var resizeId;
        ...
        function scrollPage(element, callback, isMovementUp) {
            ...
            if ($.isFunction(options.onLeave) && !v.localIsResizing) {
                if (options.onLeave.call(v.activeSection, v.leavingSection, (v.sectionIndex + 1), v.yMovement) === !1) {
                    return
                }
            }
...
//                $('.award-icon').css("bottom", "9rem");
            ...
            if (options.onSlideLeave) {
                ...
                if (!localIsResizing && xMovement !== 'none') {
                    if ($.isFunction(options.onSlideLeave)) {
                        if (options.onSlideLeave.call(prevSlide, anchorLink, (sectionIndex + 1), prevSlideIndex, xMovement, slideIndex) === !1) {
                            slideMoving = !1;
                            return
                        }
                    }
        ...
        FP.destroy = function(all) {
            FP.setAutoScrolling(!1, 'internal');
            FP.setAllowScrolling(!1);
            FP.setKeyboardScrolling(!1);
